# This Makefile is for the RTSP::Proxy extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/RTSP/Proxy.pm]
#     AUTHOR => q[Mischa Spiegelmock <revmischa@cpan.org>]
#     BUILD_REQUIRES => {  }
#     NAME => q[RTSP::Proxy]
#     PREREQ_PM => { Net::Server::PreFork=>undef, RTSP::Client=>q[0.03], Moose=>undef }
#     VERSION_FROM => q[lib/RTSP/Proxy.pm]
...
PARENT_NAME = RTSP
DLBASE = $(BASEEXT)
VERSION_FROM = lib/RTSP/Proxy.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/RTSP/Proxy.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/RTSP
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/RTSP
...
TO_INST_PM = lib/RTSP/Proxy.pm \
	lib/RTSP/Proxy/Session.pm \
	lib/RTSP/Proxy/StreamBuffer.pm \
	lib/RTSP/Proxy/Transport.pm \
	lib/RTSP/Proxy/Transport/RTP.pm

PM_TO_BLIB = lib/RTSP/Proxy/Transport.pm \
	blib/lib/RTSP/Proxy/Transport.pm \
	lib/RTSP/Proxy/StreamBuffer.pm \
	blib/lib/RTSP/Proxy/StreamBuffer.pm \
	lib/RTSP/Proxy/Session.pm \
	blib/lib/RTSP/Proxy/Session.pm \
	lib/RTSP/Proxy/Transport/RTP.pm \
	blib/lib/RTSP/Proxy/Transport/RTP.pm \
	lib/RTSP/Proxy.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/RTSP/Proxy.pm $(INST_MAN3DIR)/RTSP::Proxy.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               RTSP-Proxy' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.06' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Simple RTSP proxy server' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Mischa Spiegelmock <revmischa@cpan.org>' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Moose:                ~' >> META_new.yml
	$(NOECHO) $(ECHO) '    Net::Server::PreFork:  ~' >> META_new.yml
	$(NOECHO) $(ECHO) '    RTSP::Client:         0.03' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Simple RTSP proxy server</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Mischa Spiegelmock &lt;revmischa@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Moose::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Net::Server::PreFork" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="RTSP::Client" VERSION="0.03" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/RTSP/Proxy/Transport.pm blib/lib/RTSP/Proxy/Transport.pm \
	  lib/RTSP/Proxy/StreamBuffer.pm blib/lib/RTSP/Proxy/StreamBuffer.pm \
	  lib/RTSP/Proxy/Session.pm blib/lib/RTSP/Proxy/Session.pm \
	  lib/RTSP/Proxy/Transport/RTP.pm blib/lib/RTSP/Proxy/Transport/RTP.pm \
	  lib/RTSP/Proxy.pm blib/lib/RTSP/Proxy.pm 
